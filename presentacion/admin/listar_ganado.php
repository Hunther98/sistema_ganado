                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <?php endif; ?>
                                <a href="listar_ganado.php?accion=eliminar&id=<?php echo $animal['id']; ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('¿Estás seguro de eliminar este animal?');">
